  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        description="نظرة سريعة على المبيعات والتحصيل والأصناف الأكثر حركة"
        actions={
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard label="إجمالي المبيعات" value={money(totals.sales)} icon={<FileText className="size-4" />} />
        <StatCard label="المحصّل" value={money(totals.paid)} tone="accent" />
        <StatCard label="المتبقي على العملاء" value={money(totals.sales - totals.paid)} tone="danger" />
        <StatCard label="ضريبة القيمة المضافة" value={money(totals.tax)} tone="muted" />
      </div>
