        ...
        <Card>
          <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 rounded-lg bg-emerald-50 dark:bg-emerald-950/30">
              ...
              <div className="text-xl font-bold text-emerald-600">{summary.rev.toLocaleString('en-GB', { minimumFractionDigits: 2 })}</div>
            </div>
            <div className="text-center p-4 rounded-lg bg-red-50 dark:bg-red-950/30">
              ...
              <div className="text-xl font-bold text-red-600">{summary.exp.toLocaleString('en-GB', { minimumFractionDigits: 2 })}</div>
            </div>
